...
function domGetParent(node: Node, predicate: (predicateNode: Node) => boolean): null | Node {
      ...
      nearestEditor.update(() => {
        ...
        if (clickedNode !== null) {
          ...
          if ($isLinkNode(maybeLinkNode)) {
            ...
            const a = (
              isHTMLAnchorElement(target) ? target : domGetParent(target, isHTMLAnchorElement)
