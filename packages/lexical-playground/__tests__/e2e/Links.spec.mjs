...
test.describe('Links', () => {
  ...
  test(`Can convert multi-formatted text into a link (backward)`, async ({ page }) => {
    await focusEditor(page);
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph PlaygroundEditorTheme__ltr" dir="ltr">
          ...
          <em class="PlaygroundEditorTheme__textItalic" data-lexical-text="true"> ghi </em>
  ...
  test(`Can convert multi-formatted text into a link (forward)`, async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type(' abc');
  ...
  test(`Can create a link in a list and insert a paragraph at the start`, async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type('- hello');
  ...
  test(`Can create a link then replace it with plain text #2`, async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type(' abc ');
  ...
  test(`Can create a link then partly replace it with plain text`, async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type(' abc ');
  ...
  test.describe('Inserting text either side of links', () => {
    ...
    test.describe('Inserting text before links', () => {
      test.describe('Start-of-paragraph links', () => {
        ...
        test(`Can insert text before a start-of-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text before a start-of-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text before a start-of-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text before a start-of-paragraph link, via pasting Lexical text`, async ({ page }) => {
      ...
      test.describe('Mid-paragraph links', () => {
        ...
        test(`Can insert text before a mid-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text before a mid-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        test(`Can insert text before a mid-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        test(`Can insert text before a mid-paragraph link, via pasting Lexical text`, async ({ page }) => {
          await setup(page, 'paste:lexical');
        });
      });
      ...
      test.describe('End-of-paragraph links', () => {
        ...
        test(`Can insert text before an end-of-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text before an end-of-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text before an end-of-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text before an end-of-paragraph link, via pasting Lexical text`, async ({ page }) => {
          await setup(page, 'paste:lexical');
        });
      });
    });
    ...
    test.describe('Inserting text after links', () => {
      test.describe('Start-of-paragraph links', () => {
        ...
        test(`Can insert text after a start-of-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text after a start-of-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after a start-of-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after a start-of-paragraph link, via pasting Lexical text`, async ({ page }) => {
          await setup(page, 'paste:lexical');
        });
      });
      ...
      test.describe('Mid-paragraph links', () => {
        ...
        test(`Can insert text after a mid-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text after a mid-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after a mid-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after a mid-paragraph link, via pasting Lexical text`, async ({ page }) => {
          await setup(page, 'paste:lexical');
        });
      });
      ...
      test.describe('End-of-paragraph links', () => {
        ...
        test(`Can insert text after an end-of-paragraph link, via typing`, async ({ page }) => {
          await setup(page, 'type');
        });

        test(`Can insert text after an end-of-paragraph link, via pasting plain text`, async ({ page }) => {
          await setup(page, 'paste:plain');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after an end-of-paragraph link, via pasting HTML`, async ({ page }) => {
          await setup(page, 'paste:html');
        });

        // TODO: https://github.com/facebook/lexical/issues/4295
        test.skip(`Can insert text after an end-of-paragraph link, via pasting Lexical text`, async ({ page }) => {
          await setup(page, 'paste:lexical');
        });
      });
    });
  ...
  test(`Can convert multi-formatted text into a link and then modify text after`, async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type(' abc');
  ...
  test(`It can insert text inside a link after a formatted text node`, async ({ page }) => {
    await focusEditor(page);
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph PlaygroundEditorTheme__ltr" dir="ltr">
          <a class="PlaygroundEditorTheme__link PlaygroundEditorTheme__ltr" dir="ltr" href="https://" rel="noopener">
            <span data-lexical-text="true">This is the</span>
            <strong class="PlaygroundEditorTheme__textBold" data-lexical-text="true"> boldest </strong>
            <span data-lexical-text="true">link</span>
          </a>
        </p>
      `,
  ...
  test(`It can insert text inside a link before a formatted text node`, async ({ page }) => {
    await focusEditor(page);
  ...
  test(`Can delete text up to a link and then add text after`, async ({ page }) => {
    await focusEditor(page);
    ...
    await assertHTML(
      ...
      html`
        <p class="PlaygroundEditorTheme__paragraph PlaygroundEditorTheme__ltr" dir="ltr">
          <span data-lexical-text="true"> This is an Awesome Website right? </span>
        </p>
      `,
    );
  ...
  test(`Can convert part of a text node into a link with forwards selection`, async ({ page, browserName }) => {
    await focusEditor(page);
  ...
  test(`Can convert part of a text node into a link with backwards selection`, async ({ page, browserName }) => {
    await focusEditor(page);
    await page.keyboard.type('Hello world');
  ...
  test(`Can convert part of a text node into a link and change block type`, async ({ page, browserName }) => {
    await focusEditor(page);
    await page.keyboard.type('Hello world');
  ...
  test('Can handle pressing Enter inside a Link containing multiple TextNodes', async ({ page, isCollab }) => {
  ...
  test('Can handle pressing Enter at the beginning of a Link', async ({ page }) => {
    await focusEditor(page);
    await page.keyboard.type('Hello awesome');
    await selectAll(page);
    await click(page, '.link');
  ...
  test('Can handle pressing Enter at the end of a Link', async ({ isCollab, page }) => {
