...
import { applySelectionInputs, pasteHTML } from '@lexical/selection/src/__tests__/utils';
...
describe('LexicalEventHelpers', () => {
  ...
  describe('onPasteForRichText', () => {
    ...
    describe('W3 spacing', () => {
      const suite = [
        {
          expectedHTML: '<p class="editor-paragraph" dir="ltr"><span data-lexical-text="true">hello world</span></p>',
        ...
        },
        {
          ...
          expectedHTML: '<p class="editor-paragraph" dir="ltr"><span data-lexical-text="true"> hello world</span></p>',
          inputs: [pasteHTML(' <span style="white-space: pre"> hello </span> world  ')],
        ...
        {
          expectedHTML: '<p class="editor-paragraph" dir="ltr"><span data-lexical-text="true">a b c</span></p>',
        ...
        {
          expectedHTML: '<p class="editor-paragraph" dir="ltr"><span data-lexical-text="true">a</span></p>',
        ...
        },
        {
          ...
          inputs: [pasteHTML(`<span style="white-space: pre">\na\r\nb\r\n</span>`)],
