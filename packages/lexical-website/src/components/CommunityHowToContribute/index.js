      ...
      <div class="row">
        ...
        <p>
          ...
          <Link to="https://github.com/facebook/lexical/blob/main/CODE_OF_CONDUCT.md">
            <Translate id="pages.community.howTo.codeOfConductLink" description="Hyperlink to code of conduct">
              Code of Conduct
            </Translate>
          </Link>
          .{' '}
          ...
          <Link to="https://www.contributor-covenant.org/">
            <Translate id="pages.community.howTo.covenantLink" description="Hyperlink to contributor covenant">
        ...
        <p>
          ...
          <Link to="https://github.com/facebook/lexical" description="Hyperlink to GitHub repo">
            <Translate id="pages.community.contributors.joinUsRepoLink">Lexical GitHub repository</Translate>
          </Link>
          .
        </p>
      </div>
