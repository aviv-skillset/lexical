    ...
    <div className="row">
      <div className={clsx('col col--6', styles.textContainer)}>
        ...
        <p>
          ...
          >
            We are deeply committed to being open-source. That means openly helping each other in improving Lexical.
            We've listed some Lexical-related communities that you should check out.
          </Translate>
        </p>
      </div>
